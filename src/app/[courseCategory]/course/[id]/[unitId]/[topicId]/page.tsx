                        ...
                        <li className="list-none ml-8 mb-2" key={video?.videoId}>
                            <Link href={video.url}>
                                <div className="relative flex w-max mb-4 rounded-xl overflow-hidden">
                                    ...
                                    <span
                                        className="absolute material-symbols-outlined z-50 top-1/2 translate-y-[-50%] left-[150px] translate-x-[-50%] !text-5xl text-white">
                    play_circle
                  </span>
                                </div>
                            </Link>
                                    ...
                                    onClick={() => {
                                        if (
                                            ...
                                            Promise.all([
                                                ...
                                                fetch(
                                                    `https://webapi-zu6v4azneq-el.a.run.app/admin/course/${
                                                        pathname.split("course/")[1]
      ...
      <ul className="mt-4">
        ...
        <li className="text-orange-500 font-medium uppercase ml-4 my-4 border-2 border-orange-500 rounded-full w-max px-4 py-2 text-sm">
          <a href={pathname + "/add-important-questions"}>Add questions</a>
            ...
            {isLoading && (
                <div
                    className="w-full left-0 h-full absolute bg-black/80 top-0 z-[100] flex items-center justify-center">
