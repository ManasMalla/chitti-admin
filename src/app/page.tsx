...
export default function Home() {
    ...
    return (<>
            {isSignedIn ? <main>
                <div className="w-full h-full flex p-12 gap-12">
                    ...
                    <div className="flex flex-col max-w-[480px] grow">
                        <p className="text-xl font-bold text-[var(--primary)] mb-12 ">CHITTI.</p>
            ...
            </main> : <main className="w-full h-full flex p-12 gap-12">
                <img
                    className="rounded-xl"
                    src="https://w0.peakpx.com/wallpaper/400/821/HD-wallpaper-aesthetic-study-laptop-study.jpg"
                    alt={"Image of a study table"}/>
                <div className="flex flex-col gap-12 max-w-[480px] grow">
                    ...
                    <div className="grow"/>
                    <p className="text-gray-600">© 2025 <span className="font-medium text-black">theananta</span>. All
                        Rights Reserved.</p>
                </div>
            </main>}
        </>
